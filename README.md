...
[GNU AGPL-3.0](LICENSE) — Copyright (c) 2026 catdevdog

자유롭게 사용·수정·재배포할 수 있습니다. 다만 수정본을 **배포하거나 네트워크 서비스로 제공**하는 경우, 그 소스도 같은 라이선스로 공개해야 합니다.

키 입력을 다루는 앱이라 이 조건은 의도적입니다 — TypingRank를 표방하는 어떤 빌드든 소스를 검증할 수 있어야 합니다.
